    ...
    if not st.session_state.authenticated:
        ...
        if st.button("💾 Kaydet"):
            try:
                ...
                pass  # Railway'de dosya yazılamasa da devam et
            # Session state'e de kaydet — kalıcı olmasa da o oturum için geçerli
            st.session_state.manual_results = results_admin
            st.session_state.pop("live_results", None)  # API sonuçlarını sıfırla, manual alsın
            st.cache_data.clear()
